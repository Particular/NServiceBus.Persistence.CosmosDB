...
public sealed class TransactionalBatchOperationException : Exception
{
    ...
    /// </summary>
    public TransactionalBatchOperationException(TransactionalBatchOperationResult result) : base(result.StatusCode.ToString("G")) => Result = result;

    /// <summary>
    /// Initializes a new TransactionalBatchOperationException with a message and a <see cref="TransactionalBatchOperationResult"/>.
    /// </summary>
    public TransactionalBatchOperationException(string message, TransactionalBatchOperationResult result) : base(message) => Result = result;
