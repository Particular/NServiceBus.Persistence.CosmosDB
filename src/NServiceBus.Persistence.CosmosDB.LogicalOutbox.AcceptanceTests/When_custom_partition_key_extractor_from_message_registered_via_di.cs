...
public class When_custom_partition_key_extractor_from_message_registered_via_di : NServiceBusAcceptanceTest
{
    [Test]
    public async Task Should_be_used()
    {
        ...
        Context context = await Scenario.Define<Context>()
            ...
            {
                b.Services(services => services.AddSingleton<IPartitionKeyFromMessageExtractor>(sp => new EndpointWithCustomExtractor.CustomExtractor(sp.GetRequiredService<Context>())));
