...
[TestFixture]
public class When_no_default_container_and_extractor_is_configured_with_both_pk_extractors_configured : NServiceBusAcceptanceTest
{
    [Test]
    public async Task Message_extractor_for_pk_should_be_used()
    {
