...
public class PartitionKeyExtractorTests
{
    ...
    [SetUp]
    public void SetUp() => extractor = new PartitionKeyExtractor();
    ...
    public void Should_not_extract_from_header_with_no_matching_key()
    {
        ...
        bool wasExtracted = extractor.TryExtract(headers, out PartitionKey? partitionKey);
    ...
    public void Should_throw_when_header_is_already_mapped()
    {
        ...
        ArgumentException exception = Assert.Throws<ArgumentException>(() => extractor.ExtractPartitionKeyFromHeader("HeaderKey"));
    ...
    public void Should_not_extract_from_message_with_no_match()
    {
        ...
        bool wasExtracted = extractor.TryExtract(message, new Dictionary<string, string>(), out PartitionKey? partitionKey);
    ...
    public void Should_extract_from_message_with_headers()
    {
        ...
        bool wasExtracted = extractor.TryExtract(message, headers, out PartitionKey? partitionKey);
    ...
    public void Should_throw_when_message_type_is_already_mapped()
    {
        ...
        ArgumentException exception = Assert.Throws<ArgumentException>(() => extractor.ExtractPartitionKeyFromMessage<MyMessage>(m => new PartitionKey(m.SomeId)));
